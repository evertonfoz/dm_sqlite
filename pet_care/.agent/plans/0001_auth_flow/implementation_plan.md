...
| --- | --- | --- |
| 1 | Camadas de Domínio e Dados (AuthRepository & SupabaseAuthRepository) | ⬜ Pendente |
...
### Fase 1: Camadas de Domínio e Dados
...
### Fase 3: Camada de Apresentação - Telas Públicas
